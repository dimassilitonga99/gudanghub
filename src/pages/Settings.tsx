...
import { CABANG, SESSION, APP, ROUTES } from '@/lib/config';
        ...
        <Card className="p-5">
          <div className="mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Tambah, ubah, nonaktifkan, dan reset password akun</p>
            </div>
          </div>
          <Button variant="outline" onClick={() => navigate(ROUTES.users)}>
            <Icon name="users" size={16} />
            <span className="ml-2">Buka Kelola User</span>
          </Button>
        </Card>
      )}
