 ...
 * Mouse position is kept in refs so the shader loop never triggers React re-renders.
 */
export function SmokeyBackground({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      gl.uniform2f(
        iMouseLocation,
        hoverRef.current ? mouseRef.current.x : width / 2,
        hoverRef.current ? height - mouseRef.current.y : height / 2,
      );
